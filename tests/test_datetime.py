...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "YYYY-MM-DD HH:mm:ss.SSSSSS X x",
            "1969-12-31 23:59:59.999999",
            ("UTC", 0),
            "1969-12-31 23:59:59.999999 -1 -1",
        ),
        (
            "YYYY-MM-DD HH:mm:ss.SSSSSS X x",
            "1970-01-01 00:00:00.00",
            ("UTC", 0),
            "1970-01-01 00:00:00.000000 0 0",
        ),
        (
            "YYYY-MM-DD HH:mm:ss.SSSSSS X x",
            "1970-01-01 00:00:00.000001",
            ("UTC", 0),
            "1970-01-01 00:00:00.000001 0 1",
        ),
        (
            "YYYY-MM-DD HH:mm:ss.SSSSSS X x",
            "1970-01-01 00:59:59.500000",
            ("CET", +3600),
            "1970-01-01 00:59:59.500000 -1 -500000",
        ),
        (
            "YYYY-MM-DD HH:mm:ss.SSSSSS X x",
            "1969-12-31 23:00:00.500000",
            ("AST", -3600),
            "1969-12-31 23:00:00.500000 0 500000",
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("YYYY-MM-DD HH-mm-ss zz Z ZZ", -3661, "2018-06-09 01-02-03 ABC -01:01:01 -010101"),
    ],
)
