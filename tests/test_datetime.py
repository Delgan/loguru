...
@pytest.mark.parametrize('time_format, date, expected', [
    ('%Y-%m-%d %H-%M-%S %f %Z', (2018, 6, 9, 1, 2, 3, 45, 'UTC', 0), "2018-06-09 01-02-03 000045 UTC"),
    ('YYYY-MM-DD HH-mm-ss SSSSSS zz', (2018, 6, 9, 1, 2, 3, 45, 'UTC', 0), "2018-06-09 01-02-03 000045 UTC"),
    ('YY-M-D H-m-s SSS Z', (2005, 4, 7, 9, 3, 8, 2320, 'A', 3600), "05-4-7 9-3-8 002 +01:00"),
    ('Q_DDDD_DDD d_E h_hh A SS ZZ', (2000, 1, 1, 14, 0, 0, 900000, 'B', -1800), "1_001_1 5_6 2_02 PM 90 -0030"),
